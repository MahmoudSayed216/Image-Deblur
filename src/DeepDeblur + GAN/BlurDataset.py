...
class GoProDataset(Dataset):
    def __init__(self, data_path: str, mode:str=Literal["train", "test"], transforms = None):
        super().__init__()
        self.go_pro_resolution = (1280, 720)
        self.cropped_region_side_length = 256
        self.scaling_factor = 0.5
        self.sharp_base = os.path.join(data_path, mode, "sharp")
        self.blur_base = os.path.join(data_path, mode, "blur")
        self.mode = mode        
    ...
    def __getitem__(self, index):
        ...
        return (_256_scale_sharp, _128_scale_sharp, _64_scale_sharp), (_256_scale_blur, _128_scale_blur, _64_scale_blur)
